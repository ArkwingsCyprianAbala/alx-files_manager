...
-   Project to be done in teams of 2 people (your team: Cyprian Abala)
...
-   Otherwise:
    -   By using the module mime-types, get the [MIME-type](https://intranet.alxswe.com/rltoken/d9Q53g6bNHvm1IvBQyOxyw) based on the name of the file
...
Now that you are ready to be reviewed, share your link to your peers. You can find some [here](https://intranet.alxswe.com/projects/1246#available-reviewers-modal).

https://intranet.alxswe.com/corrections/64165353/correct

Don't forget to [review one of them](https://intranet.alxswe.com/corrections/to_review).

Reviews will close on **Dec 14, 2024** at **6:00 AM**
